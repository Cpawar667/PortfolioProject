public class final WorkoutPlanner1 extends WorkoutPlannerSecondary {
    import components.map.Map;
import components.map.Map.Pair;
import components.map.Map1L;

/**
 * {@code WorkoutPlanner} represented as a {@code Map} with primary methods.
 *
 * @mathmodel <pre>
