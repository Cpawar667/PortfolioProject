...
public interface WorkoutPlanner extends WorkoutPlannerKernel {
        ...
        /**
         * Replaces the soreness level associated with the given muscle group
         * key with {@code newSorenessLevel} and returns the old soreness level.
         *
         * @param muscleGroup
        ...
        /**
         * Generates a workout plan consisting of a Sequence of muscle groups
         * that are suitable for training (where soreness is less than the
         * specified mandatory rest level).
         *
         * @param mandatoryRestLevel
         *                the SorenessLevel that indicates a mandatory
         *                rest/avoid status
        ...
        /**
         * Generates a Map of muscle groups that are too sore to train, along
         * with their soreness levels.
         *
         * @param mandatoryRestLevel
         *                the SorenessLevel that indicates a mandatory
         *                rest/avoid status
