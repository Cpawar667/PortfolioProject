...
- Designed abstract class for WorkoutPlanner component that is compilable with the kernel and secondary methods.

### Updated

- Changed design to include compilable secondary methods
```
